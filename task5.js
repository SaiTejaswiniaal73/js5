...
alert("hey know shall we check greate and lessthen number b/w 2 numbers")
let num1=prompt("enter first number");
let num2=prompt("enter secound number");
let number1=num1;
let number2=num2;
alert(number1>number2?"1st number is greater then 2nd number":"secound number is greater then 1st number");
